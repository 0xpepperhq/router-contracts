...
import {IPepperRouteProcessor} from "./interfaces/IPepperRouteProcessor.sol";
...
contract PepperRouteProcessor is IPepperRouteProcessor, Ownable, ReentrancyGuard, Pausable {
        ...
        uint256 realAmountIn = amountIn;
        {
            ...
            for (uint256 index = 0; index < route.length; index++) {
                ...
                if (segment.providerCode == 0) {
                    ...
                    segment.providerCode == 2 ||
                    segment.providerCode == 4 ||
                    segment.providerCode == 6
                ) {
                    ...
                    segment.providerCode == 1 ||
                    segment.providerCode == 3 ||
                    segment.providerCode == 5
                ) {
